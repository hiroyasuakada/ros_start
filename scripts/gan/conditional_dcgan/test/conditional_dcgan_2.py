...
class ConditionalDCGAN(object):
    ...
    # def train(self, real_images, conditions, batch_size):  # (real_images, conditions, BATCH_SIZE)
    ...
    #     generated_images = self._generator.predict([random_latent_vectors, conditions], verbose=0)
