...
class DataArrangement(object):
    ...
    def resize_data(self):
        for prepared_data in self.prepared_data_directories:
            ...
            path = './{}_{}/dataset_for_cyclegan_by_csv/{}'.format(self.height, self.width, prepared_data)
...
########################################################################################################################
                        ...
                        if prepared_data == 'train_not_tracking':
                            cv2.imwrite('./{}_{}/with_binary_mask_4_situation_by_csv/trainB'.format(self.height, self.width) +
                                        '/' + output_name, bgr_image)
                            cv2.imwrite('./{}_{}/without_mask_4_situation_by_csv/trainB'.format(self.height, self.width) +
                                        '/' + output_name, bgr_image)

                        elif prepared_data == 'train_tracking':
                            cv2.imwrite('./{}_{}/without_mask_4_situation_by_csv/trainA'.format(self.height, self.width) +
                                        '/' + output_name, bgr_image)

                        elif prepared_data == 'train_tracking_with_binary_mask':
                            cv2.imwrite('./{}_{}/with_binary_mask_4_situation_by_csv/trainA'.format(self.height, self.width) +
                                        '/' + output_name, bgr_image)

                        if prepared_data == 'test_qualitative':
                            cv2.imwrite('./{}_{}/without_mask_4_situation_by_csv/test_qualitative'.format(self.height, self.width) +
                                        '/' + output_name, bgr_image)

                        elif prepared_data == 'test_qualitative_with_binary_mask':
                            cv2.imwrite('./{}_{}/with_binary_mask_4_situation_by_csv/test_qualitative_with_binary_mask'.format(self.height, self.width) +
                                        '/' + output_name, bgr_image)

                        elif prepared_data == 'test_quantitative_as_gt':
                            cv2.imwrite('./{}_{}/with_binary_mask_4_situation_by_csv/test_quantitative_as_gt'.format(self.height, self.width) +
                                        '/' + output_name, bgr_image)
                            cv2.imwrite('./{}_{}/without_mask_4_situation_by_csv/test_quantitative_as_gt'.format(self.height, self.width) +
                                        '/' + output_name, bgr_image)

                        elif prepared_data == 'test_quantitative_by_hand':
                            cv2.imwrite('./{}_{}/without_mask_4_situation_by_csv/test_quantitative_by_hand'.format(self.height, self.width) +
                                        '/' + output_name, bgr_image)
