...
class ResultArrangement(object):
    def __init__(self, path_to_project_1, path_to_project_2, individual_img):
        self.path_to_project_1 = path_to_project_1
        self.path_to_project_2 = path_to_project_2
        # self.path_to_project_2 = 'test_quantitative_with_binary_mask_by_hand'
        self.path_to_project = './' + self.path_to_project_1 + '/' + self.path_to_project_2
    ...
    def evaluate(self):
        if self.individual_img is not None:
            img_real = cv2.imread('./test_quantitative_as_gt/{}'.format(self.individual_img))
            ...
            real_files = glob.glob('./test_quantitative_as_gt/*.jpg')

            for file in natsorted(real_files):
                get_file_name = os.path.basename(file)
                print(get_file_name)
                img_real = cv2.imread('./test_quantitative_as_gt/{}'.format(get_file_name))
...
if __name__ == '__main__':
    ...
    parser.add_argument('arg1', help='dir_name_for_project_1')  # for example, without_mask_4_situation
    parser.add_argument('arg2', help='dir_name_for_project_2')  # for example, test_quantitative_by_hand
    parser.add_argument('-img', '--arg3', help='evaluate_individual_img')

    args = parser.parse_args()

    RA = ResultArrangement(args.arg1, args.arg2, args.arg3)
    # RA.arrange()
    RA.evaluate()
